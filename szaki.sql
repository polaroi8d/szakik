...
CREATE TABLE  "MUNKA" 
   (	"M_ID" NUMBER(2,0) NOT NULL ENABLE, 
	"NEV" VARCHAR2(30), 
	 CONSTRAINT "MUNKA_PRIMARY_KEY" PRIMARY KEY ("NEV") ENABLE
   ) ;
​
   
CREATE TABLE  "SZAKI" 
   (	"SZ_ID" NUMBER(*,0) NOT NULL ENABLE, 
	"NEV" VARCHAR2(100) NOT NULL ENABLE, 
	"NEVE" VARCHAR2(40), 
	"FELHASZNALONEV" VARCHAR2(20), 
	"JELSZO" VARCHAR2(20), 
	"CIM" VARCHAR2(100), 
   ...
   ) ;ALTER TABLE  "SZAKI" ADD CONSTRAINT "SZAKI_FOREIGN_KEY" FOREIGN KEY ("NEV")
...
CREATE TABLE  "HIRDETES" 
   (	"H_ID" NUMBER(4,0) NOT NULL ENABLE, 
	...
	"DATUM" DATE, 
	"SZOVEG" VARCHAR2(500), 
	 CONSTRAINT "HIRDETES_PRIMARY_KEY" PRIMARY KEY ("H_ID", "SZ_ID", "DATUM") ENABLE
   ) ;ALTER TABLE  "HIRDETES" ADD CONSTRAINT "HIRDETES_FOREIGN_KEY" FOREIGN KEY ("SZ_ID")
...
CREATE TABLE  "PANASZ" 
   (	"F_ID" NUMBER(4,0) NOT NULL ENABLE, 
	"PANASZ" VARCHAR2(100) NOT NULL ENABLE, 
	 CONSTRAINT "PANASZ_PRIMARY_KEY" PRIMARY KEY ("F_ID") ENABLE
